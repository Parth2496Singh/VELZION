...
const Dashboard = () => {
  ...
  const calculateFinOps = (env) => {
    ...
    // Updated May 2026 AWS Pricing (us-east-1)
    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#12121a', color: '#fff', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      <div style={{ flex: 1, padding: '40px', overflowY: 'auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '30px' }}>
          <div>
            <h1 style={{ color: '#00d2ff', margin: '0 0 5px 0' }}>🚀 Velzion Control Plane</h1>
            <p style={{ color: '#aaa', margin: '0' }}>BYOC Ephemeral Environments Engine</p>
          </div>
          <Link to="/finopscalculator" style={{ 
            padding: '12px 24px', 
