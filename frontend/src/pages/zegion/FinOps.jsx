...
export default function FinOpsCalculator() {
  ...
  const spotHourly = 0.0043; 
  const ebsHourly = 0.0022;  
  ...
  return (
    <div style={{ paddingBottom: '4rem', maxWidth: '1000px', margin: '0 auto' }}>
      <style>{`
        ...
        .tooltip-text { 
          visibility: hidden; width: 280px; background: var(--bg-layer-2); backdrop-filter: blur(24px) saturate(180%); 
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={springPage} style={{ marginBottom: '3rem' }}>
        <h1 style={{ color: 'var(--text-pure)', margin: '0 0 0.5rem 0', fontSize: 'clamp(2rem, 4vw, 2.5rem)', fontWeight: 800, letterSpacing: '-0.02em', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <Calculator size={36} strokeWidth={1.5} style={{ color: 'var(--zg-purple-core)' }} />
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="show" className="glass-panel" style={{ padding: '3rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
          
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '1.5rem', gridColumn: '1 / -1', background: 'var(--bg-layer-2)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontSize: '1.25rem', fontWeight: 800, color: 'var(--zg-purple-core)', background: 'var(--zg-purple-glow)', padding: '0.25rem 0.75rem', borderRadius: 'var(--radius-sm)' }}>
                {prsPerMonth} PRs
              </span>
            </div>
          ...
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '1.5rem', background: 'var(--bg-layer-2)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, color: '#ef4444' }}>{standardLifespanDays} Days</span>
            </div>
          ...
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '1.5rem', background: 'var(--bg-layer-2)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, color: '#10b981' }}>{activeHoursPerPr}h</span>
            </div>
          ...
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '1.5rem', gridColumn: '1 / -1', background: 'var(--bg-layer-2)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1.5rem' }}>
              ...
              <span style={{ fontFamily: 'var(--font-mono)', fontWeight: 700, color: '#f59e0b' }}>{strictTtlHours}h</span>
            </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.5rem' }}>
          <motion.div variants={itemVariants} style={{ background: 'var(--bg-layer-2)', padding: '1.5rem', borderRadius: 'var(--radius-md)', border: 'var(--border-subtle)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <h3 style={{ fontFamily: 'var(--font-mono)', fontSize: '2.5rem', fontWeight: 800, margin: 0, color: '#ef4444' }}>${competitorTotalCost.toFixed(2)}</h3>
          </motion.div>
          ...
          <motion.div variants={itemVariants} style={{ background: 'var(--bg-layer-2)', padding: '1.5rem', borderRadius: 'var(--radius-md)', border: 'var(--border-subtle)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <h3 style={{ fontFamily: 'var(--font-mono)', fontSize: '2.5rem', fontWeight: 800, margin: 0, color: 'var(--zg-purple-core)' }}>${velzionTotalCost.toFixed(2)}</h3>
          </motion.div>

          <motion.div variants={itemVariants} style={{ gridColumn: 'span 2', background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.3)', textAlign: 'center', padding: '2.5rem', borderRadius: 'var(--radius-md)' }}>
            ...
            <h2 style={{ color: 'var(--text-pure)', fontSize: '3.5rem', fontWeight: 800, margin: '0.5rem 0', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem', fontFamily: 'var(--font-mono)' }}>
              ${totalSavings.toFixed(2)} 
              <span style={{ fontSize: '1.5rem', opacity: 0.8, fontWeight: 600, color: '#10b981', display: 'flex', alignItems: 'center', fontFamily: 'var(--font-sans)' }}>
                <Activity size={24} strokeWidth={1.5} style={{ marginRight: '0.5rem' }}/> {savingsPercent}% ROI
              </span>
            </h2>
          </motion.div>
        </div>

        <motion.button variants={itemVariants} onClick={() => setShowDetailedAudit(!showDetailedAudit)} style={{ width: '100%', padding: '1.25rem', marginTop: '2rem', background: showDetailedAudit ? 'var(--bg-layer-2)' : 'transparent', border: '1px dashed var(--border-subtle)', color: showDetailedAudit ? 'var(--text-pure)' : 'var(--text-muted)', borderRadius: 'var(--radius-sm)', cursor: 'pointer', fontWeight: 600, transition: 'all var(--transition-fast)', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '0.5rem' }}>
          {showDetailedAudit ? 'Hide Detailed FinOps Audit' : 'View Detailed Compute & Storage Waste Analysis'}
          <ChevronDown size={18} strokeWidth={1.5} style={{ transform: showDetailedAudit ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform var(--transition-smooth)' }} />
        </motion.button>
        
        <AnimatePresence>
          {showDetailedAudit && (
            <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }} transition={springCrisp} style={{ overflow: 'hidden' }}>
              <div style={{ background: 'var(--bg-layer-2)', borderRadius: 'var(--radius-sm)', border: 'var(--border-subtle)', marginTop: '1.5rem', padding: '1.5rem' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ padding: '1rem', borderBottom: '1px solid rgba(255,255,255,0.02)', color: 'var(--text-pure)', textAlign: 'right', fontFamily: 'var(--font-mono)' }}>${standardComputeCost.toFixed(2)}</td>
                    </tr>
                    <tr>
                      ...
                      <td style={{ padding: '1rem', borderBottom: '1px solid rgba(255,255,255,0.02)', color: 'var(--text-pure)', textAlign: 'right', fontFamily: 'var(--font-mono)' }}>${standardEbsCost.toFixed(2)}</td>
                    </tr>
                    <tr style={{ background: 'rgba(255,255,255,0.03)' }}>
                      ...
                      <td style={{ padding: '1rem', color: '#ef4444', textAlign: 'right', fontFamily: 'var(--font-mono)', fontWeight: 800 }}>${competitorTotalCost.toFixed(2)}</td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td style={{ padding: '1rem', borderBottom: '1px solid rgba(255,255,255,0.02)', color: 'var(--text-pure)', textAlign: 'right', fontFamily: 'var(--font-mono)' }}>${zegionComputeCost.toFixed(2)}</td>
                    </tr>
                    <tr>
                      ...
                      <td style={{ padding: '1rem', borderBottom: '1px solid rgba(255,255,255,0.02)', color: 'var(--text-muted)' }}>${ebsHourly.toFixed(4)}</td>
                      <td style={{ padding: '1rem', borderBottom: '1px solid rgba(255,255,255,0.02)', color: 'var(--text-pure)', textAlign: 'right', fontFamily: 'var(--font-mono)' }}>${zegionEbsCost.toFixed(2)}</td>
                    </tr>
                    <tr style={{ background: 'rgba(255,255,255,0.03)' }}>
                      <td style={{ padding: '1rem', color: 'var(--text-pure)', fontWeight: 700 }}>Total Zegion Run Rate</td>
                      <td style={{ padding: '1rem' }}></td><td style={{ padding: '1rem' }}></td>
                      <td style={{ padding: '1rem', color: 'var(--zg-purple-core)', textAlign: 'right', fontFamily: 'var(--font-mono)', fontWeight: 800 }}>${velzionTotalCost.toFixed(2)}</td>
                    </tr>
                    <tr><td colSpan="4" style={{ height: '1rem' }}></td></tr>
                    <tr style={{ background: 'rgba(239, 68, 68, 0.1)' }}>
                      <td colSpan="3" style={{ padding: '1rem', color: '#ef4444', fontWeight: 700 }}>Idle Compute Hours Prevented (Waste vs Actual Use)</td>
                      <td style={{ padding: '1rem', color: '#ef4444', textAlign: 'right', fontFamily: 'var(--font-mono)', fontWeight: 800 }}>-{idleComputeHoursWasted.toLocaleString()} hrs</td>
                    </tr>
                    <tr style={{ background: 'rgba(245, 158, 11, 0.1)' }}>
                      <td colSpan="3" style={{ padding: '1rem', color: '#f59e0b', fontWeight: 700 }}>Idle Storage Hours Prevented (Waste vs TTL)</td>
                      <td style={{ padding: '1rem', color: '#f59e0b', textAlign: 'right', fontFamily: 'var(--font-mono)', fontWeight: 800 }}>-{idleStorageHoursWasted.toLocaleString()} hrs</td>
                    </tr>
                    <tr style={{ background: 'rgba(16, 185, 129, 0.15)' }}>
                      <td colSpan="3" style={{ padding: '1rem', color: '#10b981', fontWeight: 700 }}>Total Financial Impact</td>
                      <td style={{ padding: '1rem', color: '#10b981', textAlign: 'right', fontFamily: 'var(--font-mono)', fontWeight: 800 }}>-${totalSavings.toFixed(2)}/mo</td>
                    </tr>
                  </tbody>
                </table>
              </div>
        ...
        <motion.div variants={itemVariants} style={{ marginTop: '3rem', paddingTop: '2rem', borderTop: 'var(--border-subtle)' }}>
          <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1.5rem', gap: '1rem' }}>
            ...
            <div style={{ flex: 1, height: '28px', background: 'var(--bg-layer-2)', borderRadius: '14px', border: 'var(--border-subtle)', overflow: 'hidden' }}>
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="show" style={{ marginTop: '5rem' }}>
        <motion.h2 variants={itemVariants} style={{ textAlign: 'center', color: 'var(--text-pure)', fontSize: 'clamp(1.5rem, 3vw, 2rem)', marginBottom: '0.5rem', fontWeight: 800 }}>The Evolution of Preview Environments</motion.h2>
        <motion.p variants={itemVariants} style={{ textAlign: 'center', color: 'var(--text-muted)', marginBottom: '3rem', fontSize: '1.1rem' }}>Why traditional CI/CD pipelines fail at cost optimization.</motion.p>
        
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem' }}>
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '2rem', borderTop: '4px solid #ef4444' }}>
            <div style={{ marginBottom: '1.5rem', display: 'inline-flex', padding: '1rem', borderRadius: 'var(--radius-md)', background: 'var(--bg-layer-2)', border: 'var(--border-subtle)', color: 'var(--text-pure)' }}><Server size={24} strokeWidth={1.5} /></div>
          ...
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '2rem', borderTop: '4px solid #f59e0b' }}>
            <div style={{ marginBottom: '1.5rem', display: 'inline-flex', padding: '1rem', borderRadius: 'var(--radius-md)', background: 'var(--bg-layer-2)', border: 'var(--border-subtle)', color: 'var(--text-pure)' }}><Cloud size={24} strokeWidth={1.5} /></div>
          ...
          <motion.div variants={itemVariants} className="glass-panel" style={{ padding: '2rem', borderTop: '4px solid var(--zg-purple-core)', background: 'linear-gradient(180deg, var(--zg-purple-glow) 0%, var(--bg-layer-1) 100%)' }}>
            <div style={{ marginBottom: '1.5rem', display: 'inline-flex', padding: '1rem', borderRadius: 'var(--radius-md)', background: 'var(--bg-layer-2)', border: '1px solid var(--zg-purple-border)', color: 'var(--zg-purple-core)' }}><Rocket size={24} strokeWidth={1.5} /></div>
      ...
      <motion.div variants={containerVariants} initial="hidden" animate="show" className="glass-panel" style={{ marginTop: '5rem', padding: '3rem', background: 'var(--bg-layer-2)' }}>
        <motion.h3 variants={itemVariants} style={{ color: 'var(--text-pure)', fontSize: 'clamp(1.5rem, 3vw, 1.75rem)', marginTop: 0, marginBottom: '2.5rem', textAlign: 'center', fontWeight: 800 }}>Under the Hood: The Aggressive TTL Lifecycle</motion.h3>
        
        <motion.div variants={itemVariants} className="lifecycle-step">
          <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-layer-2)', border: '2px solid var(--zg-purple-core)', color: 'var(--zg-purple-core)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.25rem', fontWeight: 800, zIndex: 2, flexShrink: 0, boxShadow: '0 0 15px var(--zg-purple-glow)' }}>1</div>
          <div>
        ...
        <motion.div variants={itemVariants} className="lifecycle-step">
          <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-layer-2)', border: '2px solid var(--zg-purple-core)', color: 'var(--zg-purple-core)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.25rem', fontWeight: 800, zIndex: 2, flexShrink: 0, boxShadow: '0 0 15px var(--zg-purple-glow)' }}>2</div>
          <div>
            <h4 style={{ color: 'var(--text-pure)', margin: '0 0 0.5rem 0', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        ...
        <motion.div variants={itemVariants} className="lifecycle-step">
          <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-layer-2)', border: '2px solid var(--zg-purple-core)', color: 'var(--zg-purple-core)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.25rem', fontWeight: 800, zIndex: 2, flexShrink: 0, boxShadow: '0 0 15px var(--zg-purple-glow)' }}>3</div>
          <div>
            <h4 style={{ color: 'var(--text-pure)', margin: '0 0 0.5rem 0', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
        ...
        <motion.div variants={itemVariants} className="lifecycle-step" style={{ marginBottom: 0 }}>
          <div style={{ width: '48px', height: '48px', borderRadius: '50%', background: 'var(--bg-layer-2)', border: '2px solid var(--zg-purple-core)', color: 'var(--zg-purple-core)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '1.25rem', fontWeight: 800, zIndex: 2, flexShrink: 0, boxShadow: '0 0 15px var(--zg-purple-glow)' }}>4</div>
          <div>
            <h4 style={{ color: 'var(--text-pure)', margin: '0 0 0.5rem 0', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
